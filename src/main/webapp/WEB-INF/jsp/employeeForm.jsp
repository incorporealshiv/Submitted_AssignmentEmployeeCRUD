...
function confirmUpdate() {
    ...
    return confirm("Are you sure you want to save the information?");
}
...
<body>
    ...
    <div class="form-container">
        <h4>Please Enter Below Information Carefully</h4>

        <!-- Show Error Message if Duplicate Found -->
       <c:if test="${error == 'duplicate'}">
    <p style="color: red; font-weight: bold;">Error: An employee with the same email and phone already exists.</p>
</c:if>
   ...
   <!--  <div class="form-row">
    ...
    <form:input path="salary" id="salary" required="true" oninput="allowNumericInput(event)" />
        ...
        <!-- Back Button -->
        <a href="/employees/all-employees?page=1&size=5" class="back-button">Back to Employee List</a>
    </div>
